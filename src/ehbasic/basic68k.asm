...
; Use this value to run out of RAM
	ORG		$002000			; past the vectors in a real system

UART_RXBUF      EQU  $80000200
UART_TXBUF      EQU  $80000200
UART_LINESTAT   EQU  $80000205
...
;        LEA.L    BASE_UART,A0      ; A0 points to console ACIA
;TXNOTREADY
